...
const HARDCODED_SYMBOLS = [
  ...
  { ticker: 'UBER', nameKr: '우버',                 nameEn: 'Uber Technologies',        market: 'us', exchange: 'NYSE',   sector: 'Industrials',            industry: 'Software—Application',     type: 'stock' },
  { ticker: 'LYFT', nameKr: '리프트',               nameEn: 'Lyft',                     market: 'us', exchange: 'NASDAQ', sector: 'Industrials',            industry: 'Software—Application',     type: 'stock' },
  { ticker: 'SNAP', nameKr: '스냅',                 nameEn: 'Snap Inc',                 market: 'us', exchange: 'NYSE',   sector: 'Communication Services', industry: 'Internet Content',         type: 'stock' },
  { ticker: 'PINS', nameKr: '핀터레스트',           nameEn: 'Pinterest',                market: 'us', exchange: 'NYSE',   sector: 'Communication Services', industry: 'Internet Content',         type: 'stock' },
  { ticker: 'SHOP', nameKr: '쇼피파이',             nameEn: 'Shopify',                  market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software—Application',     type: 'stock' },
  { ticker: 'SQ',   nameKr: '블록',                 nameEn: 'Block (Square)',           market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software—Infrastructure',  type: 'stock' },
  { ticker: 'SOFI', nameKr: '소파이',               nameEn: 'SoFi Technologies',        market: 'us', exchange: 'NASDAQ', sector: 'Financials',             industry: 'Credit Services',          type: 'stock' },
  { ticker: 'HOOD', nameKr: '로빈후드',             nameEn: 'Robinhood Markets',        market: 'us', exchange: 'NASDAQ', sector: 'Financials',             industry: 'Capital Markets',          type: 'stock' },
  { ticker: 'SNOW', nameKr: '스노우플레이크',       nameEn: 'Snowflake',                market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software',                 type: 'stock' },
  { ticker: 'U',    nameKr: '유니티',               nameEn: 'Unity Software',           market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software',                 type: 'stock' },
  { ticker: 'NET',  nameKr: '클라우드플레어',       nameEn: 'Cloudflare',               market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software—Infrastructure',  type: 'stock' },
  { ticker: 'OKTA', nameKr: '옥타',                 nameEn: 'Okta',                     market: 'us', exchange: 'NASDAQ', sector: 'Technology',             industry: 'Software',                 type: 'stock' },
  { ticker: 'DKNG', nameKr: '드래프트킹스',         nameEn: 'DraftKings',               market: 'us', exchange: 'NASDAQ', sector: 'Consumer Discretionary', industry: 'Gambling',                 type: 'stock' },
  { ticker: 'RBLX', nameKr: '로블록스',             nameEn: 'Roblox',                   market: 'us', exchange: 'NYSE',   sector: 'Communication Services', industry: 'Electronic Gaming',        type: 'stock' },
  { ticker: 'RIVN', nameKr: '리비안',               nameEn: 'Rivian Automotive',        market: 'us', exchange: 'NASDAQ', sector: 'Consumer Discretionary', industry: 'Auto Manufacturers',       type: 'stock' },
  { ticker: 'LCID', nameKr: '루시드',               nameEn: 'Lucid Group',              market: 'us', exchange: 'NASDAQ', sector: 'Consumer Discretionary', industry: 'Auto Manufacturers',       type: 'stock' },
  { ticker: 'NIO',  nameKr: '니오',                 nameEn: 'NIO Inc (ADR)',            market: 'us', exchange: 'NYSE',   sector: 'Consumer Discretionary', industry: 'Auto Manufacturers',       type: 'stock' },
  { ticker: 'XPEV', nameKr: '샤오펑',               nameEn: 'XPeng (ADR)',              market: 'us', exchange: 'NYSE',   sector: 'Consumer Discretionary', industry: 'Auto Manufacturers',       type: 'stock' },
  { ticker: 'BABA', nameKr: '알리바바',             nameEn: 'Alibaba Group (ADR)',      market: 'us', exchange: 'NYSE',   sector: 'Consumer Discretionary', industry: 'Internet Retail',          type: 'stock' },
  { ticker: 'TME',  nameKr: '텐센트뮤직',           nameEn: 'Tencent Music (ADR)',      market: 'us', exchange: 'NYSE',   sector: 'Communication Services', industry: 'Entertainment',            type: 'stock' },
  { ticker: 'SE',   nameKr: '씨리미티드',           nameEn: 'Sea Limited',              market: 'us', exchange: 'NYSE',   sector: 'Consumer Discretionary', industry: 'Internet Retail',          type: 'stock' },
  { ticker: 'GRAB', nameKr: '그랩',                 nameEn: 'Grab Holdings',            market: 'us', exchange: 'NASDAQ', sector: 'Industrials',            industry: 'Software—Application',     type: 'stock' },
  { ticker: 'DOCN', nameKr: '디지털오션',           nameEn: 'DigitalOcean',             market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software—Infrastructure',  type: 'stock' },
  { ticker: 'TWLO', nameKr: '트윌리오',             nameEn: 'Twilio',                   market: 'us', exchange: 'NYSE',   sector: 'Technology',             industry: 'Software',                 type: 'stock' },
  { ticker: 'ZM',   nameKr: '줌',                   nameEn: 'Zoom Communications',      market: 'us', exchange: 'NASDAQ', sector: 'Technology',             industry: 'Software',                 type: 'stock' },
  { ticker: 'ROKU', nameKr: '로쿠',                 nameEn: 'Roku',                     market: 'us', exchange: 'NASDAQ', sector: 'Communication Services', industry: 'Entertainment',            type: 'stock' },
  { ticker: 'SPOT', nameKr: '스포티파이',           nameEn: 'Spotify Technology',       market: 'us', exchange: 'NYSE',   sector: 'Communication Services', industry: 'Internet Content',         type: 'stock' },
  { ticker: 'ETSY', nameKr: '엣시',                 nameEn: 'Etsy',                     market: 'us', exchange: 'NASDAQ', sector: 'Consumer Discretionary', industry: 'Internet Retail',          type: 'stock' },
  { ticker: 'BNTX', nameKr: '바이오엔테크',         nameEn: 'BioNTech (ADR)',           market: 'us', exchange: 'NASDAQ', sector: 'Healthcare',             industry: 'Biotechnology',            type: 'stock' },
  { ticker: 'NVAX', nameKr: '노바백스',             nameEn: 'Novavax',                  market: 'us', exchange: 'NASDAQ', sector: 'Healthcare',             industry: 'Biotechnology',            type: 'stock' },
